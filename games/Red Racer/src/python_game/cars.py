...
CAR_ROSTER = {
    ...
    "Corvette": {
        "display_name": "Chevrolet Corvette C8",
    ...
    "Lambo": {
        "display_name": "Lamborghini Aventador",
        "archetype": "boost",
...
def build_car_effects(car_key):
    ...
    """
    car = CAR_ROSTER.get(car_key, CAR_ROSTER.get("Ferrari"))
