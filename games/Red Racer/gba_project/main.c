...
const CarDef car_defs[NUM_CARS] = {
  ...
  {"Felucia",  0,  2, 0     , 211, 82, 78, 75,  95, 0.95f, 1.02f, 50, 100},
  {"Suprex",  8,  2, 0     , 155, 55, 85, 80, 114, 1.05f, 1.10f, 55,  95},
  {"Aurion",  3,  8, 1500  , 205, 70, 82, 78, 110, 0.96f, 1.06f, 58,  95},
  {"Corveda",  5,  2, 500   , 194, 72, 70, 72, 105, 0.98f, 0.98f, 60, 100},
  {"Lotrix", 10,  5, 3000  , 180, 65, 95, 88, 108, 0.99f, 1.15f, 35, 105},
  {"P11", 11,  8, 12000 , 205, 85, 92, 90,  92, 0.95f, 1.12f, 42, 108},
  {"Astor",  9,  3, 8000  , 211, 78, 75, 74,  98, 0.96f, 1.02f, 55, 102},
  {"Merren",  4,  8, 5000  , 202, 75, 68, 70,  95, 0.97f, 1.00f, 72, 100},
  {"Vyrex", 12,  4, 18000 , 206, 80, 58, 62,  85, 0.98f, 0.92f, 78, 110},
  {"Lumbra",  1,  5, 35000 , 211, 86, 76, 72,  88, 0.94f, 1.08f, 52, 125},
  {"Marlon",  2,  6, 25000 , 208, 88, 80, 82,  90, 0.93f, 1.02f, 40, 105},
  {"Zondra", 13,  8, 50000 , 217, 84, 82, 78,  85, 0.94f, 1.04f, 32, 114},
  {"CXR",  7,  8, 70000 , 245, 90, 65, 68,  82, 0.92f, 0.95f, 30, 120},
  {"Vexa",  6,  4, 99000 , 253, 95, 60, 65,  75, 0.90f, 1.10f, 80, 110},
};
...
void resetSaveData() {
  ...
  save_data.magic = SRAM_MAGIC;
  save_data.version = SAVE_VERSION;
  save_data.cars_unlocked = 0x0003; // Suprex + Corveda
