...
from app.routes import (
    ...
    ai_routes, image_routes, voice_routes,
)
...
def create_app() -> FastAPI:
    ...
    # CORS middleware
    cors_env = os.getenv("CORS_ORIGINS", "http://localhost:5173,http://localhost:4173")
    ...
    application.include_router(voice_routes.router)
